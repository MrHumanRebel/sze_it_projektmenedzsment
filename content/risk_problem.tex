...
\begin{table}[H]
    ...
    \begin{tabular}{p{4cm} p{2cm} p{2cm} p{5cm}}
        ...
        \bottomrule
    \end{tabular}
    \caption{Kockázatkezelési mátrix a TeDeRMS projekthez. \footnotesize Forrás: saját kép}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=60mm, keepaspectratio]{figures/problem.jpg}
    \caption{Problémamegoldási folyamat vizualizációja. \footnotesize Forrás: saját kép}
