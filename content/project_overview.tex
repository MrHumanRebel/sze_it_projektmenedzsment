...
\begin{figure}[H]
    ...
    \caption{Bejelentkezés és csatlakozás a vállalathoz. \footnotesize Forrás: saját kép}
    \label{fig:login}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Dashboard a fő erőforrásmutatókkal. \footnotesize Forrás: saját kép}
    \label{fig:dashboard}
\end{figure}
