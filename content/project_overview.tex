...
%----------------------------------------------------------------------------
A bejelentkezési felület biztosítja, hogy a felhasználók biztonságosan és ellenőrzött módon férjenek hozzá a rendszerhez.
...
\begin{itemize}
    ...
    \item \textbf{Csoport és kategória szerinti szűrés:} csak adott projekt-típushoz vagy technikai kategóriához tartozó eszközök jelenjenek meg.
...
A projekt forráskódja a \textbf{GitHub} platformon található, amely által elérhető a verziók követése, a biztonsági mentések készítése és a folyamatos fejlesztés.  
...
A GitHub repository tartalmazza a \texttt{docker-compose.yml} és \texttt{nginx.conf} fájlokat, amelyek segítik a rendszer gyors telepítését bármely környezetben — fejlesztői, teszt vagy éles szerveren — egyetlen parancs segítségével.
