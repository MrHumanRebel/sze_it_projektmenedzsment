...
\newcommand{\cim}{Egyedi igényekre szabott vállalati bérlés- és projektmenedzsment rendszer fejlesztése} % Cím
...
\include{content/project_overview}
\include{content/project_lifecycle}
\include{content/risk_problem}
